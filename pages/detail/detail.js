        ...
        var o = getApp().globalData,
          ...
          i = {
            ...
            onShareAppMessage: function (a) {
              ...
              return o && (e = "pages/detail/detail?uid=" + o + "&id=" + this.voddata.vod_id), this.api.onShare(this.voddata.vod_name + "在线观看", e, this.voddata.vod_pic)
            },
            ...
            methods: {
              ...
              init: function () {
                ...
                "1" == o.$config.play.isPoints && t.getStorageSync("$adNum") < parseInt(o.$config.play.num) && (0 == o.$config.play.hasOwnProperty("interval") && o.$config.play.interval, t.getStorageSync("$interval") || t.setStorageSync("$interval", 0), n - t.getStorageSync("$interval") > parseInt(o.$config.play.interval) ? o.$points = !0 : console.log(t.getStorageSync("$interval") + parseInt(o.$config.play.interval) - n + "开始下次广告")), "1" == o.$config.site.message.radio && (this.message = !0), wx.createInterstitialAd && i.wxAdId.cpId && (this.interstitialAd = wx.createInterstitialAd({
                  ...
                  if (a && a.isEnded) {
                    ...
                    o.$config.detail.adMsg.hasOwnProperty("close") && (s = o.$config.detail.adMsg.close), t.showModal({
                      content: s,
                      confirmColor: "#ff9900",
                      success: function (t) {
                        t.confirm && i.adTab()
              ...
              refresh: function (a) {
                ...
                this.api.apiRequest(d).then((function (a) {
                  t.hideLoading(), 200 == a.Code && a.Data.items.length > 0 ? (i.voddata = i.api.vodCl(a.Data.items[0]), i.doubanView(), t.setStorageSync("$voddata", i.voddata), e.likedata = a.Data.level.list, e.init(), i.voddata.vod_name && t.setNavigationBarTitle({
              ...
              searchDouban: function (a) {
                ...
                t.request({
                  ...
                  dataType: "json",
                  success: function (t) {
                    if (t.data.subjects.length > 0)
                      for (var i = t.data.subjects, n = 0; n < i.length; n++) {
                        var d, s = i[n].title.replace(/[\·|\s*]/g, "");
                        if (a = a.replace(/[\·|\s*]/g, ""), a.indexOf(s) >= 0 || s.indexOf(a) >= 0)
                          if (i[n].hasOwnProperty("actors") && 0 != i[n].actors.length && "" !== e.voddata.vod_actor && (d = e.voddata.vod_actor.indexOf(i[n].actors[0].name), console.log("actor:" + d)), d < 0 && i[n].hasOwnProperty("directors") && 0 != i[n].directors && "" !== e.voddata.vod_director && (d = e.voddata.vod_director.indexOf(i[n].directors[0].name), console.log("directors:" + d)), d < 0 && e.voddata.vod_year == i[n].year && (d = 1, console.log("year:" + d)), d >= 0) {
                            e.voddata.vod_score = i[n].rating.value, e.voddata.vod_douban_score = i[n].rating.value, e.voddata.vod_douban_id = i[n].id, i[n].rating.count > e.voddata.vod_hits && (e.voddata.vod_hits = i[n].rating.count), e.voddata.vod_class = i[n].genres.join(","), o.doubanInfo();
                            break
                          }
                      }
                  },
              ...
              doubanInfo: function () {
                var t = {};
                this.picError && (t.vod_pic = this.voddata.vod_pic), t.vod_id = this.voddata.vod_id, t.vod_douban_score = this.voddata.vod_douban_score, t.vod_score = this.voddata.vod_score, t.vod_douban_id = this.voddata.vod_douban_id, t.vod_duration = this.voddata.vod_duration, t.vod_class = this.voddata.vod_class, t.vod_tag = this.voddata.vod_tag, t = JSON.stringify(t);
              ...
              poster: function (a, e) {
                ...
                this.api.apiRequest(d).then((function (a) {
                  200 == a.Code && 0 != a.Data.imgUrl ? i.posterImg = a.Data.imgUrl : i.posterImg = o.$config.site.sharepic, wx.previewImage({
                    current: i.posterImg,
                    urls: [i.posterImg]
                  }), t.hideLoading()
                }))
              ...
              getDouban: function () {
                ...
                t.request({
                  ...
                  success: function (o) {
                    (a.voddata.vod_douban_score != o.data.rating.value || a.picError && a.voddata.vod_pic !== o.data.pic.normal) && (a.voddata.vod_douban_score = o.data.rating.value, a.voddata.vod_score = o.data.rating.value, a.voddata.vod_duration = o.data.durations[0], a.voddata.vod_class = o.data.genres.join(","), a.picError && (a.voddata.vod_pic = o.data.pic.normal), t.setStorageSync("$voddata", a.voddata), a.doubanInfo())
                  },
                  fail: function () {}
                })
              },
              ...
              play: function () {
                ...
                if ("1" == o.$config.detail.play.radio && o.$config.detail.play.APPID) o.$config.detail.play.APPID.indexOf("pages") >= 0 ? t.navigateTo({
                  ...
                  o.$config.detail.adMsg.hasOwnProperty("start") && (i = o.$config.detail.adMsg.start), t.showModal({
                    content: i,
                    success: function (t) {
