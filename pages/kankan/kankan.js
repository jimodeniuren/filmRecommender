          ...
          r = {
            ...
            methods: {
              ...
              getPlayUrl: function (i, t) {
                ...
                this.episode = this.voddata.vod_play_url[i][1].length, this.adPlay = !0, -1 != e.indexOf(".m3u8") || -1 != e.indexOf(".mp4") ? (this.tipShow = !0, this.tipText = "加载成功,即将播放", this.playurl = e) : this.getjx(e, this.voddata.vod_play_url[i][3])
              },
              getjx: function (i, t) {
                var e = this;
                i = n.b64_encode(i), this.tipShow = !0, this.tipText = "正在解析影片";
                ...
                this.api.apiRequest(o).then((function (i) {
                  200 == i.Code && (200 == i.Data.code ? (e.playurl = i.Data.url, e.tipText = "加载成功,即将播放") : (e.tipText = "加载失败,正在切换线路", e.laiyuanindex = Number(e.laiyuanindex), e.laiyuanindex + 1 < e.voddata.vod_play_from.length ? (e.laiyuanindex += 1, e.getPlayUrl(e.laiyuanindex, e.index)) : e.tipText = "加载失败,切换线路试试"))
                }), (function (i) {
                  e.tipText = "加载失败,正在切换线路", e.laiyuanindex + 1 < e.voddata.vod_play_from.length ? (e.laiyuanindex += 1, e.getPlayUrl(e.laiyuanindex, e.index)) : e.tipText = "加载失败,切换线路试试"
                }))
              },
              ...
              ended: function () {
                0 != this.episode && this.index + 1 < this.episode ? (this.index = this.index + 1, this.mylist[1].icon = "", this.rate = "1.0", this.initialTime = 0, this.playurl = "", this.tipShow = !0, this.tipText = "即将播放下一集...", this.getPlayUrl(this.laiyuanindex, this.index)) : this.myVideo.stop()
              },
              ...
              timeupdate: function (t) {
                ...
                if (e.currentTime = Math.floor(t.detail.currentTime), e.points && s.$points && e.currentTime > e.second && e.videoPlay && d) {
                  ...
                  var n = "打赏下,观看广告完成后继续播放,每天仅需观看2次广告!";
                  s.$config.play.adMsg.hasOwnProperty("start") && (n = s.$config.play.adMsg.start), console.log("激励广告"), i.showModal({
                    content: n,
                    success: function (i) {
